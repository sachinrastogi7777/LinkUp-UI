                    ...
                    <div className="relative px-4 sm:px-6 md:px-10 pb-6 sm:pb-8">
                        ...
                        <div className="bg-white bg-opacity-95 backdrop-blur-xl rounded-2xl sm:rounded-3xl shadow-lg sm:shadow-xl p-4 sm:p-6 mt-4 sm:mt-6">
                            <h3 className="text-lg sm:text-xl font-bold text-gray-800 mb-4 flex items-center gap-2">
                                ...
                                <span className="text-sm sm:text-base lg:text-lg">{`Connections (${connectionList ? connectionList.length : 0})`}</span>
                                                ...
                                                >
                                                    ...
                                                    <div className="flex flex-col gap-3 sm:hidden">
                                                        <div className='flex items-start gap-2.5'>
                                                            ...
                                                            <div className="flex-1 min-w-0">
                                                                ...
                                                                <span className='font-medium text-gray-500 text-sm block mt-1'>
                                                    ...
                                                    <div className="hidden lg:flex items-center gap-4">
                                                        ...
                                                        <div className="flex gap-2.5 flex-shrink-0 ml-auto">
                                                            <button
                                                                className="px-4 py-2 bg-purple-600 text-white rounded-full shadow hover:bg-purple-700 transition font-semibold text-sm whitespace-nowrap"
                                                                onClick={() => {
                                                                    setSelectedUser(connection.user);
                                                                    setIsModalOpen(true);
                                                                }}
                                                            ...
                                                            <button
                                                                onClick={() => handleRemoveConnection(connection, connection.connectionId)}
                                                                className="px-4 py-2 bg-gray-200 text-gray-800 rounded-full shadow hover:bg-gray-300 transition font-semibold border border-gray-300 text-sm flex items-center justify-center gap-1.5"
                                                                disabled={loadingRequestId === connection.connectionId}
                                                            >
                                                                {loadingRequestId === connection.connectionId ? (
                                                                    <>
                                                            ...
                                                            <Link to={`/chat/${connection.user._id}`} state={{ user: connection.user }}>
                                                                <button
                                                                    className="relative px-4 py-2 bg-green-100 text-green-800 rounded-full shadow hover:bg-green-200 transition font-semibold flex items-center justify-center gap-1.5 text-sm whitespace-nowrap"
                                                                >
